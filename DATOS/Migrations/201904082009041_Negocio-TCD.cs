namespace DATOS.Migrations
{
    ...
    public partial class NegocioTCD : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.LOCALIDAD", t => t.localidad_codigoLocalidad, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.CLIENTE", t => t.cliente_codigoCliente, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.PRODUCTO", t => t.producto_codigoProducto, cascadeDelete: true)
                .ForeignKey("dbo.ORDENDECOMPRA", t => t.ordenCompra_codigoOrdenCompra, cascadeDelete: true)
                .ForeignKey("dbo.REMITODECOMPRA", t => t.remitoCompra_codigoRemitoCompra, cascadeDelete: true)
                .ForeignKey("dbo.VENTA", t => t.venta_codigoVenta, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.CATEGORIA", t => t.categoria_codigoCategoria, cascadeDelete: true)
                .ForeignKey("dbo.MARCA", t => t.marca_codigoMarca, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.PROVEEDOR", t => t.proveedor_codigoProveedor, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        codigoRemitoCompra = c.Int(nullable: false),
                        fechaEntrega = c.DateTime(nullable: false),
                ...
                .ForeignKey("dbo.ORDENDECOMPRA", t => t.codigoRemitoCompra)
                .Index(t => t.codigoRemitoCompra)
                .Index(t => t.proveedor_codigoProveedor);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.REMITODECOMPRA", "codigoRemitoCompra", "dbo.ORDENDECOMPRA");
            ...
            DropIndex("dbo.REMITODECOMPRA", new[] { "codigoRemitoCompra" });
